    ...
    def __init__(self):
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.fft_vxx_0 = fft.fft_vfc(1, True, window.blackmanharris(1), True, 1)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/Users/elizabeth98/Test assignment/04с.wav', False)
        ...
        self.blocks_stream_to_vector_0 = blocks.stream_to_vector(gr.sizeof_float*1, 1)
        ...
        self.connect((self.fft_vxx_0, 0), (self.band_pass_filter_0, 0))
